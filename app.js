  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyByTTWVOvVdy-j1klx9G04JGj7-gBFYvGA",
    authDomain: "harrington-test2.firebaseapp.com",
    databaseURL: "https://harrington-test2.firebaseio.com",
    storageBucket: "harrington-test2.appspot.com"
  };
...
$(document).ready(function () {
  ...
  $('#message-form').submit(function (event) {
    ...
    var messagesReference = firebaseDB.ref('messages');
...
var messageClass = (function () {
  ...
  function updateMessage(id, votes) {
    ...
    var messageReference = firebaseDB.ref('messages/' + id)
